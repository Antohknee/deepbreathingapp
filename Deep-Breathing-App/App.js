  ...
  return (
    <View style={MainScreenStyles.mainStyle}>
      ...
      <View style={MainScreenStyles.topMenu}>
        <View>
          <Text
            ...
            style={{ fontFamily: 'Quicksand_500Medium', fontSize: 20 }}
          >
            Resources
          </Text>
        </View>
      ...
      <View style={MainScreenStyles.selectionArea}>
        <TouchableWithoutFeedback
          onPress={() =>
            navigation.navigate('TestingWaves', {
              inhaleTime: 3,
              topHoldTime: 0,
              exhaleTime: 3,
              bottomHoldTime: 0
        ...
        >
          <View style={MainScreenStyles.buttonPanic}>
            <ImageBackground
              source={require('./App/assets/Images/panicb.png')}
              style={{
                resizeMode: 'contain',
                width: '100%',
                height: '100%',
        ...
        <View style={MainScreenStyles.bottomButtonArea}>
          ...
          >
            <View style={MainScreenStyles.Bottombuttons}>
              <ImageBackground
                source={require('./App/assets/Images/focusb.png')}
                style={{
                  resizeMode: 'contain',
                  width: '100%',
                  height: '100%',
          ...
          <TouchableWithoutFeedback
            onPress={() => navigation.navigate('StressScreen')}
          >
            <View style={MainScreenStyles.Bottombuttons}>
              <ImageBackground
                source={require('./App/assets/Images/stressb.png')}
                style={{
                  resizeMode: 'contain',
                  width: '100%',
                  height: '100%',
      ...
      <View style={MainScreenStyles.WaterlooLogo}>
        <Image
          source={require('./App/assets/WatLogo.png')}
...
function FocusScreen({ navigation }) {
  return (
    <View style={FocusScreenStyles.main}>
      ...
      <TouchableWithoutFeedback
        onPress={() => navigation.navigate('CustomRegiment')}
      >
        <Text
          style={{
            fontFamily: 'Quicksand_500Medium',
    ...
    return (
      <View style={BeginnerScreenStyles.main}>
        ...
        <View style={BeginnerScreenStyles.container}>
          ...
          >
            {Math.round(this.state.value)} seconds{' '}
          </Text>
        </View>
        <View style={BeginnerScreenStyles.continueButton}>
          <Text
            ...
            onPress={() =>
              this.props.navigation.navigate('TestingWaves', {
                inhaleTime: Math.round(this.state.value),
                topHoldTime: 0,
                exhaleTime: Math.round(this.state.value),
                bottomHoldTime: 0
              })
            }
          >
  ...
  render() {
    return (
      <View style={CustomRStyles.main}>
        ...
        <Picker
          selectedValue={this.state.inhale}
          onValueChange={this.updateInhale}
          style={{
            top: '10%',
            height: 50,
            width: 150,
        ...
        <Picker
          selectedValue={this.state.topHold}
          onValueChange={this.updateTopHold}
          style={{
            top: '10%',
            height: 50,
            width: 150,
        ...
        <Picker
          selectedValue={this.state.exhale}
          onValueChange={this.updateExhale}
          style={{
            top: '10%',
            height: 50,
            width: 150,
        ...
        <Picker
          selectedValue={this.state.bottomHold}
          onValueChange={this.updateBottomHold}
          style={{
            top: '10%',
            height: 50,
            width: 150,
        ...
        >
          <Picker.Item
            label="0"
            value="0"
            style={{ fontFamily: 'Abel_400Regular' }}
          />
          <Picker.Item label="1" value="1" />
          <Picker.Item label="2" value="2" />
          <Picker.Item label="3" value="3" />
        ...
        >
          <Text
            ...
            onPress={() =>
              this.props.navigation.navigate('TestingWaves', {
                inhaleTime: parseInt(this.state.inhale),
                topHoldTime: parseInt(this.state.topHold),
                exhaleTime: parseInt(this.state.exhale),
                bottomHoldTime: parseInt(this.state.bottomHold)
              })
            }
          >
            CONTINUE
      ...
      >
        <View style={InformationScreenStyles.paragraph}>
          ...
          <Text style={InformationScreenStyles.paragraphText}>
            ...
            application was developed by Tara Garg, Rhys Cornelious, and Marko
            Stojakovic in partnership with the University of Waterloo Faculty of
            Engineering IDEAs Clinic, SHEN Spiritual Heritage Education Network,
            and the University of Waterloo Engineering Wellness (ENGWellness)
            program.{' '}
          </Text>
          <Text style={InformationScreenStyles.paragraphText}> </Text>
          <Text style={InformationScreenStyles.paragraphText}>
            The purpose of this application is to aid individuals with reducing
            their stress response (deactivating the sympathetic nervous system
            (SNS)) through various deep breathing exercises in an effort to
            elicit a relaxation response (activating parasympathetic nervous
            system)). Research has readily proven that breathing exercises can
            effectively help individuals reduce their physiological response to
            stress and stressful stimuli.{' '}
          </Text>
          <Text style={InformationScreenStyles.paragraphText}> </Text>
          <Text style={InformationScreenStyles.paragraphText}>
            Users can choose from three main options, each with different
            functionality and preferences. Please refer to the information
            sections within each breathing function button.{' '}
          </Text>
          <Text style={InformationScreenStyles.paragraphText}> </Text>
          <Text style={InformationScreenStyles.paragraphText}>
            *Note, this application is not a diagnostic tool and is not intended
            to substitute advice/support from a medical or mental health
            professional. Users experiencing frequent severe and acute stress
            responses should seek support from a medical professional. To be
            taken to a list of resources,{' '}
            <Text
          ...
          <Text style={InformationScreenStyles.paragraphText}>
            ...
            with ‘breaths per minute’) using a scroll bar. Once the level of
            stress has been identified, the app will begin a preloaded breathing
            regimen to aid the user with reducing their breathing rate and
      ...
      <ScrollView style={ResourcesScreenStyles.scrollView}>
        <View style={ResourcesScreenStyles.paragraph}>
          ...
          <Text style={ResourcesScreenStyles.paragrapht}>
            (Mon 8:30am - 7:30pm, Tues - Fri 8:30am - 4:30pm){' '}
          </Text>
          <Text style={ResourcesScreenStyles.paragrapht}>
          ...
          <Text style={ResourcesScreenStyles.paragrapht}>
            Mental Health Resources (for UG and Grad students):{' '}
          </Text>
          ...
          <Text style={ResourcesScreenStyles.paragrapht}>
            (Region mental health and crisis services team):{' '}
          </Text>
          <Text style={ResourcesScreenStyles.paragrapht}>1-844-437-3247 </Text>
          <Text style={ResourcesScreenStyles.paragraph}> </Text>
          <Text style={ResourcesScreenStyles.paragraph}> </Text>
          <Text style={ResourcesScreenStyles.subtitle}>
    ...
    return (
      <View style={StressScreenStyles.main}>
        ...
        <View style={StressScreenStyles.container}>
          ...
          >
            Stress Level {Math.round(this.state.value)}
          </Text>
          <Text />
          <Text
            style={{
          ...
          >
            {Selection(Math.round(this.state.value))}
          </Text>
          <Text />
          <Text
            style={{
          ...
          >
            {BreathingRate(Math.round(this.state.value))}{' '}
          </Text>
        </View>
        <View style={StressScreenStyles.continueButton}>
          <Text
            ...
            onPress={() =>
              this.props.navigation.navigate('TestingWaves', {
                inhaleTime: inhaleSelection(Math.round(this.state.value)),
                topHoldTime: topHoldSelection(Math.round(this.state.value)),
                exhaleTime: exhaleSelection(Math.round(this.state.value)),
                bottomHoldTime: bottomHoldSelection(
    ...
    <View>
      <View>
        ...
        <View style={[TestingWavesStyles.container]}>
          <Animated.View
            style={[
              TestingWavesStyles.breatheBall,
              {
                scaleX: scaleAnim,
                scaleY: scaleAnim,
      ...
      <NavigationContainer>
        ...
        >
          ...
          <Stack.Screen
            ...
            options={{ title: 'Beginner' }}
          />
          <Stack.Screen
            name="CustomRegiment"
            component={CustomRegiment}
            options={{ title: 'Custom Regiment' }}
          />
          <Stack.Screen
